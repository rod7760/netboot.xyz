...
Installs a self hosted version of netboot.xyz
...
releases:
  ...
  coreos:
    ...
    name: Fedora CoreOS
    versions:
    - code_name: 38.20231014.3.0
      name: stable
    - code_name: 38.20231027.2.0
      name: testing
    - code_name: 39.20231027.1.0
      name: next
  debian:
...
Variables loaded from `vars/ubuntu.yml`.
